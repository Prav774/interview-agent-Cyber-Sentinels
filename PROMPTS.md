...
Prompt:
1.buddy now we are impotant part i am now working vicodathon (hackathon event) i give you ps and instructions help to win this hackathon

2.im working in 48 hour hackathon can you tell me the most important thing how to manage or store the all prompt or chats that i used in project creation

3.i will take the ps 2 :
### The Interview Agent
...
4.Help me in write the description for github and creation
